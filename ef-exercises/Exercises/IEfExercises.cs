...
public interface IEfExercises
{
    ...
    List<Employee> GetEmployeesByDepartmentAsync(string departmentName);
    ...
    double GetTotalSalaryByDepartmentAsync(string departmentName);
    ...
    List<Employee> GetEmployeesWithSalaryAboveAsync(double minSalary);
